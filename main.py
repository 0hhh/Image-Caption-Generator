import string #captions will on strings
import numpy as np
import os #to get dataset
# os.environ['TF_CPP_MIN_LOG_LEVEL'] = '0' #to suppress warnings
from pickle import dump,load #for training
import tensorflow as tf
import time
from PIL import Image
import matplotlib.pyplot as plt #to draw chart
from keras.applications.xception import Xception,preprocess_input #to extract features from image
from keras.preprocessing.image import load_img
from tensorflow.keras.preprocessing.text import Tokenizer
# from tensorflow.keras.preprocessing.sequence import pad_sequence
# from keras.util import pad_sequences
from keras.utils import to_categorical, get_file, pad_sequences #to covert in one encoding
...
# # Downloading the Xception model weights with retry logic
...
# # Extracting features from images using the Xception model
...
# # Extracting features from the images in the dataset
# features = extract_features(dataset_images)
# dump(features, open("features.p","wb"))
# #----Run2 -- Loading features
# # commenting the above code to load features from pickle file

features = load(open("features.p","rb"))
#load the data # Load the photos from the dataset
...
# train_descriptions =  ("descriptions.txt", train_imgs)
